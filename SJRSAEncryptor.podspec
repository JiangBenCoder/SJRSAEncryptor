#
#  Be sure to run `pod spec lint SJRSAEncryptor.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "SteveJones"
  # s.authors            = { "SteveJones" => "benkong_ah@foxmail.com" }
  # s.social_media_url   = "http://twitter.com/SteveJones"
